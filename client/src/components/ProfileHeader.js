  ...
  return (
    <View>
      ...
      <View style={styles.headerContainer}>
        ...
        <Text
          style={[styles.headerText, isFocused("ReadBooks") && styles.headerTextFocused]}
          onPress={() => navigation.navigate("ReadBooks")}
        >
          Read
        </Text>
        <View style={styles.headerDivider} />
        <Text
          style={[styles.headerText, isFocused("ListsNavigation") && styles.headerTextFocused]}
          onPress={() => navigation.navigate("ListsNavigation")}
        >
          Lists
        </Text>
        <View style={styles.headerDivider} />
